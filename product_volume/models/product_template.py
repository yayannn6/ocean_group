...
class ProductDimensionsVolume(models.Model):
    ...
    length_uom = fields.Selection(
        ...
        help="Select the unit of measure for length, breadth and height.")
    ...
    in_one_box = fields.Float(string="In One Box", help="Enter the number of products that can fit in one box", store=True)
